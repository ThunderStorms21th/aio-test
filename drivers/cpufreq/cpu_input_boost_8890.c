 ...
 *
 * 2019 - modded by @celtare21, @tetsuo55 and @ThunderStorms21th (nalas)
 * 	  added: input_boost_enabled for turn it on or off
 *	         declarations from defconfig are added here (in defconfig no needed) 
 */
...
bool input_boost_enabled = false;		/* Turn on or off the Input Boost : true or false */
unsigned int input_boost_freq_lp = 1274000;	/* boost freq for little cpu */
unsigned int max_boost_freq_lp = 1586000;	/* boost max freq for little cpu */
unsigned int input_boost_freq_hp = 1872000;	/* boost freq for big cpu */
unsigned int max_boost_freq_perf = 2288000;	/* boost max freq for big cpu */
unsigned short input_boost_duration = 30;	/* duration in ms for input boost */

/* makes settings editable by user */
